      ...
      <div className="max-w-4xl w-full space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <ScrollReveal variant="fadeUp" delay={0.2} duration={0.7}>
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition duration-300 space-y-4 backdrop-blur-md h-full">
          ...
          <ScrollReveal variant="fadeUp" delay={0.4} duration={0.7}>
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition duration-300 space-y-4 backdrop-blur-md h-full">
