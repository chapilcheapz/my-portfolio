  ...
  return (
    <div id="skills" className="min-h-screen flex items-center justify-center relative z-10 p-12 bg-black/55 border-t border-white/5">
      <div className="max-w-5xl w-full space-y-10">
        ...
        <ScrollReveal variant="fadeUp" delay={0.2} threshold={0.05}>
          <div className="bg-white/[0.02] border border-white/5 p-8 md:p-12 rounded-[32px] backdrop-blur-md shadow-2xl">
            ...
            >
              ...
              {/* HTML */}
              <motion.div variants={itemVariants} className="inline-flex items-center space-x-2.5 px-5 py-2.5 rounded-full border border-white/10 bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300 cursor-default group">
